	...
	switch (wm->id) {
		case WM9705_ID2:
			...
			case WM9713_ID2:
				...
				/* use PEN_DOWN GPIO 13 to assert IRQ on GPIO lie 2 */
...
EXPORT_SYMBOL_GPL(wm97xx_acc_pen_up);
EXPORT_SYMBOL_GPL(wm97xx_acc_pen_down);
EXPORT_SYMBOL_GPL(wm97xx_acc_startup);
EXPORT_SYMBOL_GPL(wm97xx_acc_shutdown);
